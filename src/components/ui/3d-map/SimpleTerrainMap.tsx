...
const towns: readonly Town[] = [
  {
    ...
    phone: '307-682-0143',
    email: null,
    services: ['Cased Hole E-Line', 'Braided Line Heavy duty Fishing', 'Slickline Services', 'Stand-alone Hydraulic Swab Rigs', 'Hydrotesting', 'TCP Services', 'Kinley Cutter'],
  ...
  },
  {
    ...
    phone: '307-262-3055',
    email: null,
    services: ['Slickline Services', 'Cased Hole E-Line', 'Kinley Cutter'],
  ...
  },
  {
    ...
    phone: '701-590-9750',
    email: null,
    services: ['Cased Hole E-Line', 'Braided Line Heavy duty Fishing', 'Slickline Services', 'Stand-alone Hydraulic Swab Rigs', 'TCP Services', 'RTG Drop guns', 'Kinley Cutter'],
  ...
  },
  {
    ...
    phone: '701-580-2130',
    email: null,
    services: ['Cased Hole E-Line', 'Plug and Abandonment Services', 'Braided Line Heavy duty Fishing', 'Slickline Services', 'Stand-alone Hydraulic Swab Rigs', 'TCP Services', 'RTG Drop guns', 'Kinley Cutter'],
