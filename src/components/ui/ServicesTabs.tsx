...
const Icon = ({ name, className = 'w-6 h-6' }: { name: string; className?: string }) => {
  ...
  const iconMap: Record<string, string> = {
    ...
    'tabler:link':
      'M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5 M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5',
    'tabler:droplet':
      'M7.502 19.423c2.602 2.105 6.395 2.105 8.996 0c2.602 -2.105 3.262 -5.708 1.566 -8.546l-4.89 -7.26c-.42 -.625 -1.287 -1.023 -2.174 -1.023c-.886 0 -1.754 .398 -2.174 1.023l-4.89 7.26c-1.695 2.838 -1.036 6.441 1.566 8.546z',
    'tabler:target':
    ...
    'tabler:shield-lock':
      'M12 3a12 12 0 0 0 8.5 3a12 12 0 0 1 -8.5 15a12 12 0 0 1 -8.5 -15a12 12 0 0 0 8.5 -3 M12 11m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0 M12 12l0 2.5',
    'tabler:gauge':
      'M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0 M12 12m-5 0a5 5 0 1 0 10 0a5 5 0 1 0 -10 0 M12 3v2 M12 19v2 M5 12h-2 M19 12h-2 M7.1 7.1l-1.4 1.4 M16.9 7.1l1.4 1.4 M7.1 16.9l-1.4 1.4 M16.9 16.9l1.4 1.4',
    'tabler:plug-connected':
      'M7 12l5 5l-1.5 1.5a5 5 0 1 1 -7 -7l1.5 -1.5z M17 12l-5 -5l1.5 -1.5a5 5 0 1 1 7 7l-1.5 1.5z M3 21l2.5 -2.5 M18.5 5.5l2.5 -2.5 M10 11l-2 2 M13 14l-2 2',
    'tabler:camera':
      'M5 7h1a2 2 0 0 0 2 -2a1 1 0 0 1 1 -1h6a1 1 0 0 1 1 1a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9a2 2 0 0 1 2 -2z M9 13a3 3 0 1 0 6 0a3 3 0 0 0 -6 0',
    ...
    'tabler:fish':
      'M16.69 7.44a6.973 6.973 0 0 0 -1.69 4.56c0 1.747 .64 3.345 1.699 4.571 M2 9.504c7.715 8.647 14.75 10.265 20 2.498 M18 11v.01 M11.5 10.5c-.667 1 -.667 2 0 3 M3.499 8.5c.667 1 .667 2 0 3 M8.5 7.5l-1.5 4.5 M15.988 12.917l.503 -1.917l-1.5 -4.5',
    'tabler:wave':
      'M3 12c.777 -2.048 2.17 -4.095 4.818 -5.818c2.648 -1.723 5.675 -2.182 8.182 -1.818c2.507 .364 4.926 1.362 7.227 2.944c2.3 1.582 4.545 3.782 6.773 6.818',
    'tabler:scissors':
      'M6 7m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0 M6 17m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0 M8.6 8.6l10.4 10.4 M15.4 8.6l-10.4 10.4',
  };

  const iconPath = iconMap[name] || iconMap['tabler:tool'];
  const paths = iconPath.includes(' M') ? iconPath.split(' M').map((p, i) => (i === 0 ? p : 'M' + p)) : [iconPath];
...
const services: Service[] = [
  ...
  },
  {
    ...
    details: ['Well intervention services', 'Maintenance operations', '24/7 availability'],
  },
  {
    id: 'swabbing',
    name: 'Swabbing',
    ...
    details: ['Fluid removal services', 'Production restoration', 'Quick turnaround'],
  },
  {
    id: 'perforating',
    name: 'Perforating',
    ...
    details: ['Precision perforating systems', 'TCP (Tubing Conveyed Perforating)', 'Safety-focused operations'],
  },
  {
    id: 'plugs-packers',
    ...
    details: ['Expert plug and packer setting', 'Well isolation services', 'Reliable sealing solutions'],
  },
  {
    id: 'p-a',
    ...
    details: ['Regulatory compliance', 'Safe abandonment procedures', 'Full documentation'],
  },
  {
    id: 'hydrotesting',
    name: 'Hydrotesting',
    ...
    details: ['Equipment integrity testing', 'Safety compliance', 'Certified testing'],
  },
  {
    id: 'slick-e-line',
    name: 'Slick E-Line',
    ...
    details: ['Combined capabilities', 'Latest technology', 'Innovative solutions'],
  },
  {
    id: 'cameras',
    name: 'Cameras',
    ...
    details: ['High-resolution cameras', 'Visual inspection', 'Real-time video feed'],
  },
  {
    id: 'pipe-recovery',
    name: 'Pipe Recovery',
    ...
    details: ['Specialized recovery tools', 'Minimized downtime', 'Experienced crews'],
  },
  {
    id: 'hepta-line',
    ...
    details: ['7-conductor wireline technology', 'Multi-conductor capabilities', 'Advanced logging services'],
  },
  {
    id: 'hoisting',
    ...
    details: ['Professional hoisting equipment', 'Versatile service capabilities', 'Safe operations'],
  },
  {
    id: 'fishing',
    name: 'Fishing',
    ...
    details: ['Specialized fishing tools', 'Expert recovery techniques', 'Minimized operational impact'],
  },
  {
    id: 'flow-diagnostics',
    ...
    details: ['Flow analysis services', 'Production diagnostics', 'Performance evaluation'],
  },
  {
    id: 'tcp',
    name: 'TCP',
    ...
    details: ['Tubing conveyed systems', 'Efficient completion', 'Precision perforating'],
  },
  {
    id: 'kinley-cutter',
    name: 'Kinley Cutter',
    ...
    details: ['Kinley cutter technology', 'Precision cutting', 'Safe operations'],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
            Click on any service below to learn more about our capabilities and expertise. Each service is backed by
            decades of experience and the highest safety standards.
          </p>
        </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 md:p-12 border border-gray-100 dark:border-gray-700">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-8 pb-8 border-b border-gray-200 dark:border-gray-700">
                      ...
                      <div>
                        ...
                        <p className="text-lg md:text-xl text-muted dark:text-slate-300 leading-relaxed">
                          {service.description}
                        </p>
                      </div>
                    </div>
                      ...
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {service.details.map((detail, index) => (
                          <li key={index} className="flex items-start group">
                            <span className="text-primary mr-3 mt-1 text-xl font-bold group-hover:scale-110 transition-transform">
                              ✓
                            </span>
                            <span className="text-base md:text-lg text-default dark:text-slate-300 leading-relaxed">
                              {detail}
                            </span>
                          </li>
                        ))}
